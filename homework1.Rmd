...
考量第四戰熱火輸球，湖人聽牌，原本想等到第七戰才夠刺激，三人決定提前一起收看第五場比賽，請將三人準備要一起觀賽的表定賽程資訊`Date`
與開賽時間`StartTime`, 還有`TimeZone`）從List裡面抽出來，另存為一個atomic vector，叫做`Game5Time`。
